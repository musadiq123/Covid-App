        ...
        if (this.state.loading) {
            return (
                <View style={[commonStyles.column, { flex: 1, }]}>
                    <Text style={[commonStyles.margin, commonStyles.fontFamilyBold, commonStyles.fontSize(5), { marginTop: hp('3%'), color: color.neavyBlue }]}>Status</Text>
            ...
            if (this.state.userStatus.length > 0) {
                return (
                    <View style={[commonStyles.margin, commonStyles.column, { flex: 1, marginTop: hp('3%') }]}>
                        ...
                        <Text style={[commonStyles.fontFamilyBold, commonStyles.fontSize(5), { color: color.neavyBlue }]}>Status</Text>
                        <Text style={[commonStyles.fontFamilyBold, commonStyles.fontSize(3), { marginTop: hp('2%'), color: color.neavyBlue }]}>Hello, {this.state.userData.name}</Text>
                        ...
                        <View style={{ position: 'absolute', bottom: 0, flex: 1, alignSelf: 'flex-end' }}>
                            <TouchableOpacity onPress={() => { this.state.isTodayData ? null : navigate('AddSymptomsNorCatScreen') }}>
                    ...
                    <View style={[commonStyles.margin, commonStyles.column, { flex: 1, marginTop: hp('3%') }]}>
                        ...
                        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                            <Image style={styles.noHistoryIcons}
                                source={require('../../assets/images/No-status.png')} />
                            <Text style={[commonStyles.fontFamilyBold, commonStyles.fontSize(2.7), { marginTop: hp('2%'), color: color.neavyBlue }]}>{this.state.userData.name}, we not found any status.</Text>
                            <Text style={[commonStyles.fontFamilyBold, commonStyles.fontSize(2.7), { color: color.neavyBlue }]}>Please add your status.</Text>

                        </View>

                        <View style={{ position: 'absolute', bottom: 0, flex: 1, alignSelf: 'flex-end' }}>
                            <TouchableOpacity onPress={() => { navigate('AddSymptomsNorCatScreen') }}>
                                <View style={{ alignItems: 'flex-end' }}>
                                    <Image style={styles.addButton}
                                        source={require('../../assets/images/add_button.png')} />
                                </View>
